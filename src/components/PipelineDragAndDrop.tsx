...
export default function PipelineDragAndDrop() {
  const [steps, setSteps] = useState<PipelineStep[]>([...CORRECT_ORDER].sort(() => Math.random() - 0.5));
  ...
  return (
    <div className="my-8 p-6 bg-gray-50 rounded-xl shadow-md max-w-2xl mx-auto">
      <h3 className="text-2xl font-semibold mb-4 text-center">Arrange the Pipeline Steps in Order</h3>
