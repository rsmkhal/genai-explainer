...
function Tr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), rs(e)))
    ...
    for (e = u.call(e), s = 0; !(i = e.next()).done; )
      (i = i.value), (u = r + Il(i, s++)), (o += Tr(i, t, n, u, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
var S = wa.exports;
const sd = Qc(S),
  ad = Hc({ __proto__: null, default: sd }, [S]);
/**
 * @license React
    ...
    (e.unstable_scheduleCallback = function (E, T, R) {
      ...
      return (
        ...
        R > Q
          ...
          : ((E.sortIndex = J), t(u, E), x || y || ((x = !0), Tl(j))),
        E
      );
    }),
...
function Pd(e, t, n, r, l, i, o, s, u) {
  (Rn = !1), (Vr = null), Cd.apply(_d, arguments);
}
...
var Oe = Math.clz32 ? Math.clz32 : Fd,
  ...
  Ad = Math.LN2;
function Fd(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((Md(e) / Ad) | 0)) | 0;
}
var vr = 64,
  yr = 4194304;
function Pn(e) {
...
var vf = Ke && "TextEvent" in window && !zn,
  du = Ke && (!ko || (zn && 8 < zn && 11 >= zn)),
  ks = " ",
  Ss = !1;
function fu(e, t) {
  switch (e) {
...
var Lf = Ke && "documentMode" in document && 11 >= document.documentMode,
  Vt = null,
  Ci = null,
  On = null,
  _i = !1;
...
function vl(e) {
  ...
  var t = Ht[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in xu) return (Hl[e] = t[n]);
  return e;
}
...
for (var Ql = 0; Ql < Ls.length; Ql++) {
  var Gl = Ls[Ql],
    Tf = Gl.toLowerCase(),
    Rf = Gl[0].toUpperCase() + Gl.slice(1);
  vt(Tf, "on" + Rf);
}
  ...
  if (!e[Sr]) {
    (e[Sr] = !0),
      Ia.forEach(function (n) {
        n !== "selectionchange" && (zf.has(n) || Kl(n, !1, e), Kl(n, !0, e));
      });
...
function Rs(e, t, n, r, l) {
  for (var i = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    s.tag === 5 &&
      ...
      ((s = c),
      l
        ? ((u = Bn(n, i)), u != null && o.unshift(Yn(n, u, s)))
        : l || ((u = Bn(n, i)), u != null && o.push(Yn(n, u, s)))),
      (n = n.return);
  }
...
var Ri = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Mf =
    typeof queueMicrotask == "function"
      ...
      : typeof Is < "u"
        ? function (e) {
            return Is.resolve(null).then(e).catch(Af);
          }
        : Ri;
function Af(e) {
  setTimeout(function () {
...
function xt() {
  if (!Zl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), ba(ho, xt), l);
    } finally {
      (D = t), (Zl = !1);
    }
  }
...
function Lu(e, t, n) {
  (je[Ne++] = He), (je[Ne++] = Qe), (je[Ne++] = Rt), (Rt = e);
  var r = He;
  e = Qe;
  var l = 32 - Oe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function zu(e) {
  ...
  function y(f, d, p, v, j) {
    ...
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        case hr:
          return (f = f.get(v.key === null ? p : v.key) || null), u(d, f, v, j);
        case $t:
  ...
  function x(f, d, p, v) {
    for (
      var j = null, _ = null, P = d, L = (d = 0), H = null;
      P !== null && L < p.length;
      L++
    ) {
  ...
  function w(f, d, p, v) {
    ...
    for (
      var _ = (j = null), P = d, L = (d = 0), H = null, I = p.next();
      P !== null && !I.done;
      L++, I = p.next()
    ) {
      P.index > L ? ((H = P), (P = null)) : (H = P.sibling);
...
function Do(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Mr.current = e === null || e.memoizedState === null ? Gf : Kf),
    (e = n(r, l)),
    Dn)
  ) {
    i = 0;
...
function $u(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), Wu(t) && Vu(e);
}
function Bu(e, t, n) {
  return n(function () {
    Wu(t) && Vu(e);
...
function Yu(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), wl(4, 4, Ku.bind(null, t, e), n)
  );
}
function Fo() {}
function Xu(e, t) {
  ...
  Gf = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Ar(4194308, 4, Ku.bind(null, t, e), n)
      );
    },
    ...
    useTransition: function () {
      var e = Ws(!1),
        t = e[0];
      return (e = Vf.bind(null, e[1])), (Fe().memoizedState = e), [t, e];
    },
...
function Js(e, t, n, r, l) {
  ...
  if ((nn(t, l), t.stateNode === null))
    Fr(e, t), nc(t, n, r), Fi(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      s = t.memoizedProps;
    o.props = s;
    ...
    (o.state = m),
      rl(t, r, o, l),
      (u = t.memoizedState),
      s !== r || m !== u || he.current || et
        ? (typeof g == "function" && (Ai(t, n, g, r), (u = t.memoizedState)),
          (s = et || Hs(t, n, s, r, m, u, c))
            ? (h ||
    ...
    s !== h || m !== x || he.current || et
      ? (typeof y == "function" && (Ai(t, n, y, r), (x = t.memoizedState)),
        (c = et || Hs(t, n, c, r, m, x, u) || !1)
          ? (g ||
...
function bf(e, t, n) {
  ...
  switch ((No(t), t.tag)) {
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = _t(Be.current)), Nr(t))) {
          ...
          switch (((r[Ue] = t), (r[Xn] = i), (e = (t.mode & 1) !== 0), n)) {
            ...
            case "video":
            case "audio":
              for (l = 0; l < Ln.length; l++) A(Ln[l], r);
              break;
            case "source":
              A("error", r);
              break;
          ...
          e: {
            switch (((o = yi(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (l = 0; l < Ln.length; l++) A(Ln[l], e);
                l = r;
                break;
              case "source":
                A("error", e), (l = r);
    ...
    case 4:
      return (
        cn(), Hi(e, t), e === null && Kn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
...
function np(e, t) {
  ...
  for (Li = { focusedElem: e, selectionRange: n }, Kr = !1, N = t; N !== null; )
...
function hc(e) {
  ...
  t !== null && ((e.alternate = null), hc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Xn], delete t[zi], delete t[Ff], delete t[Uf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function vc(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Te(t, e), Ae(e), r & 512 && n !== null && Zt(n, n.return);
      break;
    case 5:
      if (
        (Te(t, e),
...
function De(e, t, n, r) {
  if (50 < Fn) throw ((Fn = 0), (Zi = null), Error(k(185)));
  ir(e, n, r),
    (!(O & 2) || e !== b) &&
      (e === b && (!(O & 2) && (jl |= n), Z === 4 && nt(e, te)),
      ge(e, r),
      n === 1 && O === 0 && !(t.mode & 1) && ((fn = G() + 500), xl && xt()));
}
function ge(e, t) {
...
function xc(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = cl(e, r);
    ...
    O |= 2;
    var i = kc();
    (b !== e || te !== t) && ((We = null), (fn = G() + 500), Pt(e, t));
    do
      try {
        sp();
        break;
    ...
    _o(),
      (sl.current = i),
      (O = l),
      K !== null ? (t = 0) : ((b = null), (te = 0), (t = Z));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = ji(e)), l !== 0 && ((r = l), (t = Ji(e, l)))), t === 1)
    )
      throw ((n = tr), Pt(e, 0), nt(e, r), ge(e, G()), n);
    if (t === 6) nt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (nt(e, r), (r & 130023424) === r && ((t = Wo + 500 - G()), 10 < t))
          ) {
            if (Gr(e, 0) !== 0) break;
...
function oa(e) {
  ...
  if (n === 1) throw ((n = tr), Pt(e, 0), nt(e, t), ge(e, G()), n);
...
function Pt(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), Df(n)), K !== null))
...
function cl(e, t) {
  ...
  while (!0);
  if ((_o(), (O = n), (sl.current = r), K !== null)) throw Error(k(261));
...
function up(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    b === e &&
      (te & n) === n &&
      (Z === 4 || (Z === 3 && (te & 130023424) === te && 500 > G() - Wo)
        ? Pt(e, 0)
        : (Bo |= n)),
    ge(e, t);
}
...
function Pc(e, t, n, r, l, i, o, s, u) {
  return (
    (e = Ko(n, r, !0, e, l, i, o, s, u)),
    (e.context = _c(null)),
    (n = e.current),
    (r = ae()),
    (l = ft(n)),
...
function vp(e, t, n, r, l) {
  ...
  var u = Ko(e, 0, !1, null, null, !1, !1, "", ua);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (mo(t, n | 1), ge(t, G()), !(O & 6) && ((fn = G() + 500), xt()));
      }
      break;
    case 13:
      Ot(function () {
...
Ka = Vo;
Ya = Ot;
var yp = { usingClientEntryPoint: !1, Events: [sr, Qt, yl, Qa, Ga, Vo] },
  En = {
  ...
  let w = {
    ...
    listen(C) {
      ...
      return (
        ...
        (u = C),
        () => {
          l.removeEventListener(ca, h), (u = null);
        }
      );
    },
    createHref(C) {
...
function Rc(e, t, n, r) {
  ...
  return (
    e.forEach((i, o) => {
      ...
      else for (let u of zc(i.path)) l(i, o, u);
    }),
    t
  );
}
...
function Yp(e, t) {
  ...
  ur() || Y(!1);
  let { basename: r, navigator: l } = S.useContext(Ft),
    { hash: i, pathname: o, search: s } = Fc(e, { relative: n }),
    u = o;
  return (
    r !== "/" && (u = o === "/" ? r : ht([r, o])),
...
function Zp() {
  ...
  let e = S.useContext(bo),
    { basename: t, future: n, navigator: r } = S.useContext(Ft),
...
function eh(e, t, n, r) {
  ur() || Y(!1);
  let { navigator: l, static: i } = S.useContext(Ft),
...
function Sh(e) {
  ...
  let o = i.current,
    [s, u] = S.useState({ action: o.action, location: o.location }),
...
const jh =
  ...
  ln = S.forwardRef(function (t, n) {
    ...
    return S.createElement(
      "a",
      to({}, m, { href: x || C, onClick: w || i ? r : d, ref: n, target: u }),
    );
  });
var ga;
(function (e) {
 ...
 */ const Rh = es("X", [
  ...
  ya = [
    ...
    { name: "Dataset Origins", path: "/dataset-origins" },
    ...
    { name: "Ethics", path: "/legal-ethical" },
              ...
              a.jsx("div", {
                ...
                children: a.jsxs("button", {
                  ...
                  children: [
                    ...
                    e
                      ? a.jsx(Rh, { className: "block h-6 w-6" })
                      : a.jsx(Th, { className: "block h-6 w-6" }),
                  ],
                }),
              }),
            ],
  ...
  Oh = () =>
    a.jsxs("div", {
      ...
      children: [
        a.jsx(zh, {}),
        a.jsx("main", { className: "flex-grow pt-1", children: a.jsx(ph, {}) }),
        a.jsx(Ih, {}),
      ],
    }),
  Dh = ({ className: e = "" }) =>
    a.jsxs(ln, {
      ...
      children: ["Start Here", a.jsx(Lh, { className: "ml-2 -mr-1 h-5 w-5" })],
    }),
  Mh = () =>
    a.jsxs("div", {
            ...
            a.jsx("div", {
              ...
              children: a.jsxs("div", {
                ...
                children: [
                  ...
                  a.jsx("div", {
                    className: "mt-10",
                    children: a.jsx(Dh, { className: "text-lg px-8 py-4" }),
                  }),
                ],
              }),
            }),
        ...
        children: e.map((m, y) =>
          a.jsxs(
            "li",
            {
              ...
              children: [
                a.jsx("span", { className: "font-bold", children: m.label }),
                a.jsx("div", {
            ...
            children: [
              ...
              a.jsxs("ul", {
                ...
                children: [
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Example Prompt:" }),
                      ' "A dog on the moon"',
                    ],
                  }),
                  a.jsxs("li", {
              ...
              a.jsxs("p", {
                className: "text-gray-700 mb-4",
                children: [
                  a.jsx("b", { children: "Role of captioning pipelines:" }),
            ...
            children: [
              ...
              a.jsxs("ul", {
                ...
                children: [
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Diffusion Models:" }),
                  ...
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Autoregressive Models:" }),
                  ...
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Encoder-Decoder Models:" }),
        ...
        children: [
          ...
          a.jsxs("div", {
            ...
            children: [
              ...
              a.jsx("p", { children: "Content coming soon..." }),
            ],
          }),
        ],
      }),
        ...
        children: [
          ...
          a.jsxs("div", {
            ...
            children: [
              a.jsx("h3", {
                ...
                children: "Where Do Image–Caption Pairs Come From?",
              }),
              a.jsxs("p", {
                className: "text-gray-700 mb-4",
                children: [
                  "Modern text‑to‑image models are data-hungry: they require ",
                  a.jsx("i", { children: "billions" }),
                  " of examples that link language to pixels.  Most teams therefore combine several kinds of collections—some scraped, some donated, some purchased—to reach the necessary scale and diversity.  Below are the most common categories you are likely to encounter.",
                ],
              }),
              a.jsx("h4", {
                className: "text-xl font-semibold text-gray-800 mb-2",
                children: "Web‑Scraped Mega‑Sets",
              }),
              a.jsxs("p", {
                className: "text-gray-700 mb-4",
                children: [
                  "The backbone of nearly every large‑scale model (DALL·E 2, Stable Diffusion, Imagen, Midjourney) is a giant, automatically collected corpus. Web crawlers visit open websites—Flickr, Pinterest, Tumblr, personal blogs—and download any image accompanied by surrounding text or alt‑text.  A weak heuristic (e.g., ",
                  a.jsx("code", { children: '<img alt="…">' }),
                  ") links the image to a caption.  Because no human reviews the pairs, quality varies wildly: detailed captions like “Golden retriever catching a frisbee in Central Park, shot at f/1.8” sit next to tags such as “IMG_0487.JPG”.  The LAION‑5B release is the best‑known public example, weighing in at 240 TB and more than ",
                  a.jsx("b", { children: "five billion" }),
                  " pairs (Schuhmann et al., 2022).",
                ],
              }),
              a.jsxs("p", {
                className: "text-gray-700 mb-2",
                children: [
                  ...
                  " enormous scale, free to collect, covers long-tail concepts (niche hobbies, rare animals, meme culture).",
                ],
              }),
              a.jsxs("p", {
                className: "text-gray-700 mb-4",
              ...
              a.jsx("h4", {
                className: "text-xl font-semibold text-gray-800 mb-2",
                children: "Expert‑Curated Datasets",
              }),
              a.jsx("p", {
                className: "text-gray-700 mb-4",
                children:
              ...
              a.jsx("h4", {
                className: "text-xl font-semibold text-gray-800 mb-2",
                children: "Proprietary & Undisclosed Sources",
              }),
              a.jsxs("p", {
                className: "text-gray-700 mb-4",
                children: [
                  "For headline models like Midjourney v6 or Adobe Firefly, the full recipe is a trade secret.  Companies disclose only broad strokes (“hundreds of millions of licensed stock images”) but not the exact mix.  Lack of transparency makes it impossible to audit biases or copyright conflicts conclusively (Harvard Business Review, 2023).  From a user perspective, this opacity means you ",
                  a.jsx("i", { children: "cannot" }),
                  " tell whether your own artwork, or sensitive personal photos, were part of the training set.",
                ],
              }),
            ],
          }),
          a.jsxs("div", {
            ...
            children: [
              a.jsx("h3", {
                className: "text-2xl font-semibold text-gray-800 mb-4",
                children: "Cleaning, Filtering, and Legal Hurdles",
              }),
              a.jsx("p", {
                className: "text-gray-700 mb-4",
                children:
              ...
              a.jsxs("ul", {
                className:
                  "list-disc list-inside ml-6 text-gray-700 space-y-2 mb-4",
                children: [
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "NSFW & Violence Filters —" }),
                      " hashing or CLIP‑based detectors remove explicit or illegal content.",
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Language Filters —" }),
                      " captions with slurs or hate speech are flagged or purged.",
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Resolution & Format Checks —" }),
                      " extremely low‑resolution images, corrupt files, or SVG icons are excluded.",
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      a.jsx("b", { children: "Semantic Safety Nets —" }),
                      " some labs discard captions that mention real children’s names, personal addresses, or medical IDs.",
                    ],
                  }),
                ],
              }),
              ...
              a.jsx("div", {
                className: "border-l-4 border-red-500 bg-red-50 p-4 my-4",
                children: a.jsxs("p", {
                  className: "text-gray-800",
                  children: [
                    a.jsx("b", { children: "Copyright Gray Zone:" }),
                    " U.S. law currently treats web scraping for machine learning as an unsettled issue.  Lawsuits (e.g., ",
                    a.jsx("i", { children: "Andersen v. Stability AI" }),
                    ", 2023) argue that training on copyrighted art without permission infringes on creators’ rights.  Defendants counter that AI training is transformative fair use.  Courts have yet to set a definitive precedent.",
                  ],
                }),
              }),
            ],
            ...
            children: [
              ...
              a.jsxs("ul", {
                ...
                children: [
                  a.jsxs("li", {
                    children: [
                      "Schuhmann, C., et al. (2022). LAION‑5B. ",
                      a.jsx("a", {
                        href: "https://laion.ai/blog/laion-5b/",
                        className: "text-blue-600 underline",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        children: "https://laion.ai/blog/laion-5b/",
                      }),
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      "Lin, T.-Y., et al. (2014). MS COCO. ",
                      a.jsx("a", {
                        href: "https://arxiv.org/abs/1405.0312",
                        className: "text-blue-600 underline",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        children: "https://arxiv.org/abs/1405.0312",
                      }),
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      "Krishna, R., et al. (2017). Visual Genome. ",
                      a.jsx("a", {
                        href: "https://arxiv.org/abs/1602.07332",
                        className: "text-blue-600 underline",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        children: "https://arxiv.org/abs/1602.07332",
                      }),
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      "Prabhu & Birhane (2021). Large Datasets: A Pyrrhic Win? ",
                      a.jsx("a", {
                        href: "https://arxiv.org/abs/2006.16923",
                        className: "text-blue-600 underline",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        children: "https://arxiv.org/abs/2006.16923",
                      }),
                    ],
                  }),
                  a.jsxs("li", {
                    children: [
                      "Harvard Business Review. (2023). Generative AI’s Intellectual Property Problem. ",
                      a.jsx("a", {
                        href: "https://hbr.org/2023/04/generative-ai-has-an-intellectual-property-problem",
                        className: "text-blue-600 underline",
                        target: "_blank",
                        rel: "noopener noreferrer",
                        children: "https://hbr.org",
                      }),
                    ],
                  }),
                ],
  ...
  return a.jsx(Sh, {
    children: a.jsx(mh, {
      children: a.jsxs(de, {
        ...
        element: a.jsx(Oh, {}),
        children: [
          a.jsx(de, { index: !0, element: a.jsx(Mh, {}) }),
          a.jsx(de, { path: "introduction", element: a.jsx(Uh, {}) }),
          a.jsx(de, { path: "generative-models", element: a.jsx($h, {}) }),
          a.jsx(de, { path: "dataset-origins", element: a.jsx(Xh, {}) }),
          a.jsx(de, { path: "captioning", element: a.jsx(Bh, {}) }),
          a.jsx(de, { path: "model-architectures", element: a.jsx(Wh, {}) }),
          a.jsx(de, { path: "prompt-demo", element: a.jsx(Vh, {}) }),
          a.jsx(de, { path: "model-comparison", element: a.jsx(Hh, {}) }),
          a.jsx(de, { path: "prompt-engineering", element: a.jsx(Qh, {}) }),
          a.jsx(de, { path: "legal-ethical", element: a.jsx(Gh, {}) }),
          a.jsx(de, { path: "deep-dive", element: a.jsx(Kh, {}) }),
          a.jsx(de, { path: "references", element: a.jsx(Yh, {}) }),
        ],
      }),
    }),
  });
}
wp.render(a.jsx(Zh, {}), document.getElementById("root"));
